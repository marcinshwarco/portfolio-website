...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="lump-overview" role="tabpanel" aria-labelledby="nav-home-tab">This is a fast, W3C validated website that provides online exposure for LUMP - a Bristol-based punk rock band. Designing for LUMP was great fun as I was able to combine photography, graphic design and front end technologies.</div>
  <div class="tab-pane fade" id="lump-technologies" role="tabpanel" aria-labelledby="nav-profile-tab"><p><b>jQuery</b> - animations and mobile navigation</p><p><b>HTML and CSS</b> - markup and styling</p><p><b>DSLR camera</b> - photos</p><p><b>Photoshop</b> - graphics</p><p><b>PHP</b> - contact form</p><p><b>Bootstrap</b> - layout elements</p></div>
...
<div class="tab-pane fade" id="newsletter-technologies" role="tabpanel" aria-labelledby="nav-profile-tab"><p><b>Wordpress</b> - newsletter configuration and layout</p><p><b>DSLR camera</b> - photos</p><p><b>Photoshop</b> - graphics</p><p><b>MailPoet</b> - WordPress newsletter plugin</p></div>
<div class="tab-pane fade" id="newsletter-next-step" role="tabpanel" aria-labelledby="nav-contact-tab">The next step is to explain the newsletter configuration to future editors.</div>
</div>
<br>
...
<h2>Personal Web Developer Portfolio</h2>
  ...
  <div class="tab-content" id="nav-tabContent">
    ...
    <br>
    <pre><a href='#'><button type="button" class="btn btn-outline-secondary">Website</button></a> <a href="https://github.com/marcinshwarco/web-dev-portfolio" target="blank"><button type="button" class="btn btn-outline-dark">GitHub</button></a></pre>
    </div>
  </div>
  <br><br><br><br>
  </article>
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="graphics-overview" role="tabpanel" aria-labelledby="nav-home-tab">As the web admin for Essential-Trading Online Shop, I created several promotional product images for the homepage. I also did some graphic work for the Bristol-based startup - Cook and Crabtree. The images are stored online at p.b.photography website. </div>
